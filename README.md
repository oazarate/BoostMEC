...
## Data format
To use BoostMEC, sgRNA target regions 30 nt in length are required, consisting of 4 nt context in the 5' end + 20 nt sgRNA + 3 nt PAM + 3 nt context in the 3' end. Data should be formatted as a csv file with at least 2 columns: dataset and x30mer, with an optional 3rd column, efficiency, for observed efficiency. We have reformatted the Endo dataset from [Kim et al., 2019](https://www.science.org/doi/full/10.1126/sciadv.aax9249), available in the first sheet of [this xlsx file](https://www.science.org/doi/suppl/10.1126/sciadv.aax9249/suppl_file/aax9249_table_s3.xlsx), into a sample dataset file (sample_dataset.csv)[data/sample_dataset.csv] in the required format. The contents of this file can be replaced to produce predictions for any given sgRNA target region 30mer by following the pipeline.
